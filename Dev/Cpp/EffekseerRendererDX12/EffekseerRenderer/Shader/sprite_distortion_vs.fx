...
{
    column_major float4x4 _89_mCamera : packoffset(c0);
    column_major float4x4 _89_mProj : packoffset(c4);
    float4 _89_mUVInversed : packoffset(c8);
    float4 _89_mflipbookParameter : packoffset(c9);
};
