...
VS_Output _main(VS_Input Input, constant VS_ConstantBuffer& v_89)
{
    ...
    float4 cameraPos = v_89.mCamera * pos4;
    ...
    Output.PosVS = v_89.mProj * cameraPos;
    Output.PosP = Output.PosVS;
    Output.PosU = v_89.mProj * localBinormal;
    Output.PosR = v_89.mProj * localTangent;
    Output.PosU /= float4(Output.PosU.w);
    Output.PosR /= float4(Output.PosR.w);
    Output.PosP /= float4(Output.PosP.w);
    Output.Color = Input.Color;
    Output.UV = Input.UV1;
    Output.UV.y = v_89.mUVInversed.x + (v_89.mUVInversed.y * Input.UV1.y);
    return Output;
}

vertex main0_out main0(main0_in in [[stage_in]], constant VS_ConstantBuffer& v_89 [[buffer(0)]])
{
    main0_out out = {};
    VS_Input Input;
    ...
    VS_Output flattenTemp = _main(Input, v_89);
